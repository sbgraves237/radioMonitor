...
Using the "run all previous chunks" button took on one case 0.05 seconds user time plus 0.03 seconds system time with total elapsed time of roughly 6 seconds.  Using the "Knit" button took substantially more time in all three categories.  
